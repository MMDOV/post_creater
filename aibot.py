        ...
        input_prompt = [
            {
                ...
                "content": (
                    ...
                    "- **Internal links missing or suboptimal:**\n"
                    "  Review the related internal articles provided below (with `title`, `first_paragraphs`, `categories`, and `tags`) to identify suitable internal links:\n"
                    f"  {self.related_articles}\n"
                    "  Derive the primary intent of each article to guide placement:\n"
                    "  • Informational — for readers seeking general knowledge.\n"
                    "  • Educational / Research — for deeper analysis, comparisons, or detailed explanations.\n"
                    "  • Commercial Investigation — for evaluating options before a purchase or decision.\n"
                    "  • Transactional — for readers ready to buy, book, or submit a form.\n"
                    "  • Navigational — when a reader is looking specifically for a brand, product, or website.\n"
                    "  • Local Intent — when a reader is searching for location-specific results.\n"
                    "  Insert links naturally where they add value and context according to the intent.\n"
                    "  Use descriptive, reader-friendly anchor text derived from the article's title, first_paragraphs, or categories.\n"
                    "  Avoid keyword stuffing and overlinking. Limit to 2–5 internal links per article, distributed across sections.\n"
                    "  Only adjust links that improve the article’s SEO and user experience; do not add unnecessary links.\n\n"
                    "### Context:\n"
                    f"Title: {title}\n"
